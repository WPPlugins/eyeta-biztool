 ...
 */
class Biztool_Listviewcell_Inlineedit extends Biztool_Listviewcell {
	...
	function __construct($post_type = null, $listview_num = null, $cell_num = null) {
		...
		$this->_vars['listviewcell_type'] = 'inline_edit';
	...
	function get_manage_posts_custom_column($target_post_id) {
		...
		$str_field = $obj_field->get_inlineedit_column($target_post_id);
	...
	function get_listviewcell_form($html = "") {
		...
		<tr class="listviewcell-form-detail">
			...
			<td class="">
				<select class="target_field" name="target_field-<?php echo $this->_vars['listview_num']; ?>-<?php echo $this->_vars['cell_num']; ?>">
					<?php
